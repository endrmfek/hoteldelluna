							...
							<section class="room-area r-padding1">
								<div class="container">
										...
										<c:forEach var="r" items="${room}">
								          <div class="col-xl-4 col-lg-6 col-md-6">
								            ...
								            <div class="single-room mb-50">
								              <div class="room-img">
								                <a href="roomupdate?roomNo=${r.r_no}"><img src="assets/img/rooms/${r.r_img}" alt=""></a>
								              </div>
								              <div class="room-caption">
								                <h3><a href="roomupdate?roomNo=${r.r_no}">${r.r_roomtype}</a></h3>
								                <div class="room-info">
								                ...
								                <br>
								                <div class="room-price">
								                  <span class="room-price-currency">delete : </span>
								                  <input type="checkbox" name="del-id" value="${r.r_no}" >
								                </div>
									...
									<input type="button" class="button button4" value="추가하기"
										onclick="location.href='roomwrite'" />
									<input type="submit" class="button button4" name="cmd" value="삭제" />
								</div>
							</section>
							<!-- Room End -->
						</div>
