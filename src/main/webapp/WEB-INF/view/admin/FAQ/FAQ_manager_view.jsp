			...
			<div class="page-heading">
				...
				<section class="section">
					<div class="card">
						...
						<input type="button" value="수정" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='faqmodify?q_no=<%=q_no %>'" /> 
						<input type="button" value="삭제" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='faqdelete?q_no=<%=q_no %>'" />
						<input type="button" value="새글쓰기" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='faqwrite.do'" />
						<input type="button" value="답글쓰기" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='faqreply?q_no=<%=q_no %>'" />
										</div>
									</div>
									<!--//게시판-->
								</div>
